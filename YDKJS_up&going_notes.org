...
Review
  YDKJS series dedicated to proposition that all JS devs can and should learn all parts of language.

  Each important area of focus in language and dedicate short but dense book to fully explore all parts of it that you thought you knew but didn't.
